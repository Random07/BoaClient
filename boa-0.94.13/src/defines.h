...
#define Jinfei_LogTag
#ifdef Jinfei_LogTag
#define JinfeiLogBegin(mesg) Jinfei_log_error_mesg(__FILE__, __LINE__,__FUNCTION__, mesg)
#define JinfeiLog(mesg) Jinfei_log_to_access_log_mesg(__FILE__, __LINE__,__FUNCTION__, mesg)
#endif
